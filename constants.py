...
# Other Paths
LOG_PATH = Path(WORKING_DIR, "logs", "log.txt")  # Use subdirectory
...
GQL_QUERIES: dict[str, GQLPersistedQuery] = {
    ...
    "PlaybackAccessToken": GQLPersistedQuery(
        ...
        variables={
            "isLive": True, "isVod": False, "login": ..., "platform": "web",
    ...
    "GameDirectory": GQLPersistedQuery(
        ...
        variables={
            "limit": 30, "slug": ..., "imageWidth": 50, "includeCostreaming": False,
            "options": {
                "broadcasterLanguages": [], "freeformTags": None, "includeRestricted": ["SUB_ONLY_LIVE"],
                "recommendationsContext": {"platform": "web"}, "sort": "RELEVANCE",
                "systemFilters":[], "tags":[], "requestID": "JIRA-VXP-2397",
            },
